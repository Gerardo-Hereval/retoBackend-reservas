    ...
    <nav class="bg-gray-800">
                ...
                <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                    ...
                    <div id="menu" class="hidden sm:ml-6 sm:block" >
                        <div class="flex space-x-4">
                            ...
                            <a href="/test" class="bg-gray-800 hover:bg-gray-700 text-gray-300 px-3 py-2 rounded-md text-sm font-medium border-b-2 border-gray-600 transition-ease-in duration-700 hover:scale-110">Test</a>
                            <a href="/reservaciones" class="bg-gray-800 hover:bg-gray-700 text-gray-300 px-3 py-2 rounded-md text-sm font-medium border-b-2 border-gray-600 transition-ease-in duration-700 hover:scale-110">Reservas</a>
                        </div>
                    </div>
                </div>
        ...
        <div id="menu" class="sm:hidden hidden">
            <div class="space-y-1 px-2 pt-2 pb-3">
                ...
                <a href="/test" class="bg-gray-900 text-white block px-3 py-2 rounded-md text-base font-medium border-b-2 border-gray-600 transition-ease-in duration-700 hover:scale-110">Test</a>
                <a href="/reservaciones" class="bg-gray-900 text-white block px-3 py-2 rounded-md text-base font-medium border-b-2 border-gray-600 transition-ease-in duration-700 hover:scale-110">Reservas</a>
